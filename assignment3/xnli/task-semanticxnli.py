...
langFullName={"en":"English", "fr":"French", "ru":"Russian"}
    ...
    for target_lang in langs:
        if source_lang != target_lang:
            ...
            for i in range(200):
                ...
                task_aligner = f""" In {langFullName[target_lang]}, {choices[target_lang][0]} means true, {choices[target_lang][1]} means false and {choices[target_lang][2]} means unknown """
                ...
                final_prompt = few_shot_prompt +task_aligner+ prompt + test_prompt
                # print(final_prompt)
